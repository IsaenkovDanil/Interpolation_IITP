...
ax1.scatter(X.ravel(), Y.ravel(), Z.ravel(), color='red', s=20) #  ravel() для показа точек
...
print(f"Фактическое значение ({x_test:.3f}, {y_test:.3f}): {sin_cos_function(x_test, y_test):.4f}")