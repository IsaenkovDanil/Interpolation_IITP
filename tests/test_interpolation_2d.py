...
def test_apply_interpolation_output_shape_rgb(create_temp_image):
    ...
    result_arr = apply_interpolation_to_image(input_file, new_h, new_w, bilinear_interpolation)
